...
public class AdminHomeController extends BaseController {
    ...
    //按日期查询图表数据-ajax
    @ResponseBody
    @RequestMapping(value = "admin/home/piecharts", method = RequestMethod.GET, produces = "application/json;charset=utf-8")
    public String getPieChart() throws ParseException {
    	logger.info(JSON.toJSONString(categoryService.getPieChart()).toString());
    	return JSON.toJSONString(categoryService.getPieChart()).toString();
    }
}