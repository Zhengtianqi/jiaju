    ...
    <div class="order_info">
        ...
        <table class="table_order_orderItem">
            ...
            <c:forEach items="${requestScope.orderItemList}" var="orderItem" varStatus="i">
                <tr class="tr_shop">
                    <td><span class="span_shopTitle">类型：</span><span
                            class="span_shopName">${orderItem.productOrderItem_product.product_category.category_name}</span>
                    </td>
                    <td></td>
                    <td></td>
                    <td></td>
