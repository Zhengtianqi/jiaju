...
<nav>
    ...
    <div class="header">
        <!-- <span class="shopNameHeader">官方旗舰店</span> -->
        <img src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/Hlogo.png" style="float: laeft; height: 70px;">
                ...
                <c:forEach items="${requestScope.loveProductList}" var="product">
                    <li class="context_ul_main">
                        <div class="context_ul_img">
                            <a href="/jiaju/product/${product.product_id}">
