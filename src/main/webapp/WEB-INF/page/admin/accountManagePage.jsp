...
<head>
    <script>
        ...
        function uploadImage(fileDom) {
            ...
            //上传图片
            $.ajax({
                url: "/jiaju/admin/uploadAdminHeadImage",
                type: "post",
                data: formData,
                contentType: false,
                processData: false,
...
<div class="details_div">
    ...
    <div class="frm_div" style="display: none;">
        <label class="frm_label text_info" id="lbl_admin_profile_picture" style="display: none;">管理员头像</label>
        <img
