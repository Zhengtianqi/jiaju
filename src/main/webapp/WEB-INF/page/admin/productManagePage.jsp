    ...
    <table class="table_normal" id="table_product_list">
        ...
        <c:forEach items="${requestScope.productList}" var="product">
            <tr>
                ...
                <td><span  title="谨慎操作"><a href="javascript:void(0)" onclick="deleteThis(${product.product_id})" style="color: red;font-weight: normal !important;">删除</a></span></td>
            </tr>
        </c:forEach>
        </tbody>
    </table>
