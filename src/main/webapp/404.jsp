...
<div style="text-align: center">
    ...
    <h4 style="font-size: 40px; color: #333; margin-top: 75px;">出现了异常</h4>
    <p style="font-size: 14px; color: #777; margin-top: 25px;">此页面已无法找到，可能已经被删除或地址错误</p>
    <a class="btn" style="width: 180px; margin-top: 55px;" href="${pageContext.request.contextPath}">返回首页</a>
</div>
</body>
</html>